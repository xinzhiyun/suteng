...
<head>
    ...
    <!-- <link href="/project/suteng/project/Public/Admin/js/Bootstrap_shengshiqu/css/main.css" rel="stylesheet"> -->
...
<body class="gray-bg">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <h5>工单管理 <small>工单添加</small></h5>
                </div>
                    <div class="ibox-content">
                        <form action="/project/suteng/project/index.php/Admin/Work/add" method="post" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio i-checks">
                                    <label class="">
                                        <div class="iradio_square-green checked" style="position: relative;"><input type="radio" checked="" name="type" value="0" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div> <i></i> 安装
                                    </label>
                                    <label class="">                                       
                                        <div class="iradio_square-green" style="position: relative;"><input type="radio" name="type" value="1" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div> <i></i> 维修
                                    </label>
                                    <label class="">
                                        <div class="iradio_square-green" style="position: relative;"><input type="radio" name="type" value="2" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div> <i></i> 维护
                                    </label>
                                </div>                  
                            </div>
                            <div class="form-group">
    ...
    <script src="/project/suteng/project/Public/Admin/js/Bootstrap_shengshiqu/js/main.js"></script>
    <!-- Data picker -->
