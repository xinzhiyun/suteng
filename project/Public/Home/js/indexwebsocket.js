window.onload = function(){
    ...
    function wash(){//冲洗状态 1
        ...
        $(".btmTxt>p").css("animation", 'aImg3 3s linear infinite');
        $(".btmTxt>p>img").attr("src", "/suteng/project/Public/Home/images/wash.png");
    }
    function lesswater(){// 缺水状态
        ...
        $(".btmTxt>p").css("animation", 'aImg3 3s linear infinite');
        $(".btmTxt>p>img").attr("src", "/suteng/project/Public/Home/images/queshui.png");
    }
    function fullwater(){// 水满状态2
        ...
        $(".btmTxt>p>img").attr("src", "/suteng/project/Public/Home/images/shuiman.png");
    }
    function service (){// 修检状态 5
        ...
        $(".btmTxt>p").css(animation, 'aImg3 3s linear infinite');
        $(".btmTxt>p>img").attr("src", "/suteng/project/Public/Home/images/shebeibaoxiu.png");
    }
